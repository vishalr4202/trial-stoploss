...
exports.shyampoints = (req, res, next) => {
    ...
    if((order == 'buy' && entry_type == 'CE' && orderPlaced == false) || (order == 'sell' && entry_type=='PE' && orderPlaced == false) || (entry_type == undefined  && exchange == 'NSE' && order=='sell' && orderPlaced == false)){
